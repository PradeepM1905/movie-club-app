...
import pandas as pd
from utils.sheets import load_sheet, get_sprint_display_info, get_current_sprint, get_current_date, get_sheet_connection
...
def show():
    ...
    from utils.sheets import load_testing_config
    ...
    if st.button("🚀 Calculate & Save Sprint Points", type="primary"):
        ...
        try:
            ws_points = get_sheet_connection().worksheet("Points")
        except:
            ws_points = get_sheet_connection().add_worksheet(title="Points", rows="1000", cols="10")
        ...
        ws_users = get_sheet_connection().worksheet("Users")
